...
WHERE id_ketua_kub = ?";
                        ...
                        $search_param = '%' . $search . '%';
                        $stmt->bind_param("sssii", $id_kub, $search_param, $search_param, $offset, $limit);
                        $stmt->execute();
                        ...
                        <div class="modal-body">
                            <form id="tambahForm" method="POST" action="proses/<?= $page_title_proses ?>/tambah.php"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="id_pastor" name="id_pastor" class="form-select" required>
                                        <option value="" disabled selected>Pilih pastor</option>
                                        <?php
                                        // Ambil data pastor dari database
                                        $query_pastor = "SELECT id_pastor, nama_lengkap FROM pastor"; // Ganti dengan query yang sesuai
                                        $result_pastor = mysqli_query($koneksi, $query_pastor);
                                        while ($row_pastor = mysqli_fetch_assoc($result_pastor)) {
                                            echo '<option value="' . $row_pastor['id_pastor'] . '">' . $row_pastor['nama_lengkap'] . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="editForm" method="POST" action="proses/<?= $page_title_proses ?>/edit.php"
                                ...
                                <div class="mb-3">
                                    <label for="edit_id_pastor" class="form-label">Pastor</label>
                                    <select id="edit_id_pastor" name="id_pastor" class="form-select" required>
                                        <option value="" disabled selected>Pilih pastor</option>
                                        <?php
                                        // Ambil data pastor dari database
                                        $query_pastor = "SELECT id_pastor, nama_lengkap FROM pastor"; // Ganti dengan query yang sesuai
