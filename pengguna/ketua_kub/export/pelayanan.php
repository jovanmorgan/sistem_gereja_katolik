...
include 'laporan_pelayanan.php'; // Panggil halaman laporan
...
$outputFile = sys_get_temp_dir() . '/laporan_permohonan.pdf';
...
if (file_exists($outputFile)) {
    ...
    header('Content-Disposition: inline; filename="laporan_permohonan.pdf"');
