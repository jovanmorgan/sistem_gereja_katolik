...
<body>
    <div class="wrapper">
                            ...
                            <div class="row">
                                <div class="col-xl-4">
                                    <div class="card">
                                        ...
                                        // Periksa apakah session id_ketua_kub telah diset
                                        if (isset($_SESSION['id_ketua_kub'])) {
                                            $id_ketua_kub = $_SESSION['id_ketua_kub'];

                                            // Query SQL untuk mengambil data ketua_kub berdasarkan id_ketua_kub dari session
                                            $query = "SELECT * FROM ketua_kub WHERE id_ketua_kub = '$id_ketua_kub'";
                                            $result = mysqli_query($koneksi, $query);

                                            // Periksa apakah query berhasil dieksekusi
                                            if ($result) {
                                                // Periksa apakah terdapat data ketua_kub
                                                if (mysqli_num_rows($result) > 0) {
                                                    // Ambil data ketua_kub sebagai array asosiatif
                                                    $ketua_kub = mysqli_fetch_assoc($result);
                                        ?>
                                                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                                        <a href="javascript:void(0)"
                                                            onclick="document.getElementById('editFotoProfile').click()">
                                                            <?php if (!empty($ketua_kub['fp'])): ?>
                                                                <img src="../../assets/img/fp_pengguna/ketua_kub/<?php echo $ketua_kub['fp']; ?>"
                                                        ...
                                                        <h4 class="text-center mt-3"><?php echo $ketua_kub['nama_lengkap']; ?></h4>
                                                        <h5 class="text-center mb-2"><?php echo $ketua_kub['username']; ?></h5>
                                                    </div>
                                    </div>
                                </div>
                                <style>
                                            ...
                                            <div class="tab-content pt-2">
                                                <div class="tab-pane fade show active profile-overview"
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-lg-9 col-md-8">
                                                            <?php echo $ketua_kub['nama_lengkap']; ?>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                                    ...
                                                    <form id="editProfileForm">
                                                        <input type="text" name="id_ketua_kub" id="id_ketua_kub"
                                                            value="<?php echo $ketua_kub['id_ketua_kub']; ?>" hidden>
                                                        <div class="row mb-3">
                                                            <label for="fullName"
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="nama_lengkap" type="text"
                                                                    ...
                                                                    value="<?php echo $ketua_kub['nama_lengkap']; ?>" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="username" type="text" class="form-control"
                                                                    id="username"
                                                                    value="<?php echo $ketua_kub['username']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label for="password"
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="password" type="text" class="form-control"
                                                                    id="password"
                                                                    value="<?php echo $ketua_kub['password']; ?>" />
                                                            </div>
                                                        </div>
        ...
        <?php
                                                    ...
                                                    // Jika tidak ada data ketua_kub
                                                    echo "Tidak ada data ketua_kub.";
                                                }
                                            } else {
                                                // Jika query tidak berhasil dieksekusi
                                                echo "Gagal mengambil data ketua_kub: " . mysqli_error($koneksi);
                                            }
                                        } else {
                                            // Jika session id_ketua_kub tidak diset
                                            echo "Session id_ketua_kub tidak tersedia.";
                                        }
