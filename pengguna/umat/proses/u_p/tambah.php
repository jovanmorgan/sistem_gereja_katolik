...
$query_check = "SELECT * FROM u_p WHERE jenis_pelayanan = '$jenis_pelayanan' AND id_umat = '$id_umat'";
...
$query = "INSERT INTO u_p (id_umat, jenis_pelayanan, status) 
          VALUES ('$id_umat', '$jenis_pelayanan', '$status')";
