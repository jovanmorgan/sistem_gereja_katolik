            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    $tables = [
                        'kub' => [
                            'label' => 'KUB',
                            'icon' => 'fas fa-people-carry', // Ikon yang menunjukkan kerja sama tim
                            'color' => '#FFC107'
                        ],
                        'pelayanan' => [
                            'label' => 'Pelayanan',
                        ...
                        'umat' => [
                            'label' => 'Umat',
                            'icon' => 'fas fa-users', // Ikon yang menunjukkan komunitas
                            'color' => '#28A745' // Green
                        ],
                        'pastor' => [
                            'label' => 'Pastor',
                            'icon' => 'fas fa-user', // Ikon yang lebih sesuai dengan peran pastor
                            'color' => '#198754' // Green
                        ],
                        'ketua_kub' => [
                            'label' => 'ketua KUB',
                            'icon' => 'fas fa-user-tie', // Ikon yang menunjukkan kepemimpinan
                            'color' => '#17A2B8' // Teal
                        ]
                    ];
                    ...
                    <section class="section">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <h4>Jumlah Pelayanan Untuk Umat</h4>
