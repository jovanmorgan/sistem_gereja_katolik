        ...
        <div class="sidebar-content">
            <ul class="nav nav-secondary">
                ...
                <li class="nav-section">
                    ...
                    <h4 class="text-section">Data Akun</h4>
                </li>
                <li class="nav-item <?php echo ($current_page == 'pastor') ? 'active' : ''; ?>">
                    <a href="pastor">
                        <i class="<?php echo getIconForPage('pastor'); ?>"></i>
                        <p>Pastor</p>
                    </a>
                </li>
                <li class="nav-item <?php echo ($current_page == 'ketua_kub') ? 'active' : ''; ?>">
                    <a href="ketua_kub">
                        <i class="<?php echo getIconForPage('ketua_kub'); ?>"></i>
                        <p>Ketua KUB</p>
                    </a>
                </li>
                <li class="nav-item <?php echo ($current_page == 'umat') ? 'active' : ''; ?>">
                    <a href="umat">
                        <i class="<?php echo getIconForPage('umat'); ?>"></i>
                        <p>Umat</p>
                    </a>
                </li>
                <li class="nav-section">
                ...
                <li class="nav-item <?php echo ($current_page == 'kub') ? 'active' : ''; ?>">
                    <a href="kub">
                        <i class="<?php echo getIconForPage('kub'); ?>"></i>
                        <p>KUB</p>
                    </a>
                </li>
