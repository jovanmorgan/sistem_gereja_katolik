                                    ...
                                    <div class="card">
                                        ...
                                        ?>
                                                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                                        ...
                                                        <h4 class="text-center mt-3"><?php echo $pastor['nama_lengkap']; ?></h4>
                                                        <h5 class="text-center mb-2"><?php echo $pastor['username']; ?></h5>
                                                    </div>
                                    </div>
                                </div>
                                <style>
                                            ...
                                            <div class="tab-content pt-2">
                                                ...
                                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                                    ...
                                                    <form id="editProfileForm">
                                                        <input type="text" name="id_pastor" id="id_pastor"
                                                            value="<?php echo $pastor['id_pastor']; ?>" hidden>
                                                        <div class="row mb-3">
                                                            <label for="fullName"
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="nama_lengkap" type="text"
                                                                    ...
                                                                    value="<?php echo $pastor['nama_lengkap']; ?>" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="username" type="text" class="form-control"
                                                                    id="username"
                                                                    value="<?php echo $pastor['username']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label for="password"
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="password" type="text" class="form-control"
                                                                    id="password"
                                                                    value="<?php echo $pastor['password']; ?>" />
                                                            </div>
                                                        </div>
